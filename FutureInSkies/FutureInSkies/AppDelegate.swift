...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    fileprivate func createEntryPoint() {
        window = UIWindow(frame: UIScreen.main.bounds)
        let launchesVC = LaunchesVC()
        let navigationVC = UINavigationController(rootViewController: launchesVC)
        navigationVC.navigationBar.barStyle = .blackOpaque
        navigationVC.navigationBar.barTintColor = navBarColor
